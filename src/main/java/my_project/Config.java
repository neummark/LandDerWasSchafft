...
public class Config {
    ...
    public final static String WINDOW_TITLE = "Markus oksasr heremmr ferieidrich neaimayer";
    ...
    public final static int WINDOW_HEIGHT = 750+29;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
