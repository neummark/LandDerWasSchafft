...
public class Twee extends GraphicalObject {
    ...
    public void draw(DrawTool drawtool){
        ...
        drawtool.drawFilledRectangle(/*580,450,60,160*/, x,y,60,160);
        drawtool.setCurrentColor(76, 187, 23,255);
        drawtool.drawFilledPolygon(/*520,450 ,700,450 ,700,400 ,640,400 ,640,350 ,580,350 ,580,400, 520,400*/x-60,y,x+120,y,x+120,y-50,x+60,y-50);
